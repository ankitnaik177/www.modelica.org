...
Wolfram has released a free set of agent skills that teach AI coding assistants like Claude Code, Codex
...
Short videos demonstrating each capability are available on the [System Modeler LinkedIn page](https://www.linkedin.com/showcase/wolfram-system-modeler/), and an
overview of all AI capabilities is at [Augment AI with System Modeler](https://www.wolfram.com/system-modeler/features/feature-ai.php).
